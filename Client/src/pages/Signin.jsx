  ...
  return (
    <div className='min-h-screen mt-20'>
      <div className='flex gap-5 p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center'>{/** mx-auto
        ...
        <p className='text-sm mt-5'> Join our community and start your journey with us. Sign in to explore and share inspiring content.</p>
        ...
        <div className='flex-1'>
          ...
          <div className='flex gap-2 text-sm mt-5'>
            ...
            <Link to='/sign-up' className='text-blue-500'>Sign Up as a User</Link>
            <Link to='/admin/sign-up' className='text-blue-500'>Sign Up as an Admin</Link>
